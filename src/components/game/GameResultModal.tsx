      ...
      <DialogContent className="sm:max-w-[500px]">
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-4 text-center">
              ...
              {gameResult.status === 'won' && (
                <div className="text-green-600 font-medium mt-1">🏆 Victory achieved!</div>
              )}
            </div>
          </CardContent>
        </Card>
        ...
        {!session && onSaveRecord && (
          <form onSubmit={handleSubmit}>
            ...
            {saveStatus === 'saving' && (
              <div className="text-center text-blue-600 font-medium">💾 Saving your score...</div>
            )}
            {saveStatus === 'saved' && (
              <div className="text-center text-green-600 font-medium mb-4">✅ Score saved successfully!</div>
            )}
            {saveStatus === 'error' && (
              <div className="text-center text-red-600 font-medium">❌ Failed to save score. Please try again.</div>
            )}
